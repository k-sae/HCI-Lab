package ShapesRecognizer;// Dollar, from http://depts.washington.edu/aimgroup/proj/dollar/dollar.js
...
// ShapesRecognizer.RecognizerUtils class constants
//
...
//        size(500, 250);
//
//        recognizer = new ShapesRecognizer();
